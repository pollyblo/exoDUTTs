import type { JSONSchema4 } from '@typescript-eslint/utils/src/json-schema';
import type { ParserServices, TSESTree } from '@typescript-eslint/utils/src/ts-estree';
import type { AST } from '@typescript-eslint/utils/src/ts-eslint/AST';
import type { Linter } from '@typescript-eslint/utils/src/ts-eslint/Linter';
import type { Scope } from '@typescript-eslint/utils/src/ts-eslint/Scope';
import type { SourceCode } from '@typescript-eslint/utils/src/ts-eslint/SourceCode';
